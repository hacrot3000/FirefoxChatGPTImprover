...
const expectedGroups = ["tabs", "keyboard-shortcuts", "prompt-templates", "working-sessions", "profiles", "activation", "rules", "rule-statistics", "monitor", "target", "download", "alerts", "activity", "local-actions", "shell", "installation-guide", "save"];
