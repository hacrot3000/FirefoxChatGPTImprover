...
const expectedGroups = ["tabs", "working-sessions", "profiles", "activation", "rules", "monitor", "target", "download", "alerts", "activity", "local-actions", "shell", "installation-guide", "save"];
