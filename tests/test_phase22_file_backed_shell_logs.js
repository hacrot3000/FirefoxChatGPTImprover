...
const shellHeadingIndex = shellSection.indexOf('<h2 id="shellHeading">Local action: shell command</h2>', headingStart);
assert(shellHeadingIndex >= headingStart && shellHeadingIndex < actionsStart);
